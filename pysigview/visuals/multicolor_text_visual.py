...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 29 14:38:57 2018

A rewrite of Vispy Text visual so that we can use different colors for
different text.
...
class MulticolorTextVisual(Visual):
...
MulticolorText = create_visual_node(MulticolorTextVisual)
